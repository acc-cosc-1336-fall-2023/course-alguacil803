...
def option_1_selected():
    ...
    while num < 1 or num > 10:
        while True:
            try:
                num = int(input("Enter an number 1-10: "))
                break
            except ValueError:
                print("That isn't a number, Input a Number 1-10: ")
...
def option_2_selected():
    ...
    while num < 1 or num > 100:
        while True:
            try:
                num = int(input("Enter an number 1-100: "))
                break
            except ValueError:
                print("That isn't a number, Input a Number 1-100: ")
